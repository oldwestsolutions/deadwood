...
export default function ApplicationsPage() {
  return (
    <>
      <Head>
        <title>Applications - Deadwood Software</title>
      </Head>
      <div className="min-h-screen bg-slate-900 py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto bg-slate-800 rounded-2xl shadow-2xl p-8 border-4 border-blue-700">
          <h1 className="text-4xl font-extrabold text-white mb-6 text-center">Applications</h1>
          ...
          {/* Add more application sections/components here */}
        </div>
      </div>
    </>
  );
